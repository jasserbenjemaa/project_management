...
> = {
  blue: {
    ...
    groupHoverBg: "group-hover:bg-blue-100",
  },
  purple: {
    badgeBg: "bg-purple-100",
    icon: "text-purple-600",
    hoverBg: "hover:bg-purple-100",
    groupHoverBg: "group-hover:bg-purple-100",
  },
  green: {
    badgeBg: "bg-green-100",
    icon: "text-green-600",
    hoverBg: "hover:bg-green-100",
    groupHoverBg: "group-hover:bg-green-100",
  },
  orange: {
    badgeBg: "bg-orange-100",
    icon: "text-orange-600",
    hoverBg: "hover:bg-orange-100",
    groupHoverBg: "group-hover:bg-orange-100",
  },
  rose: {
    badgeBg: "bg-rose-100",
    icon: "text-rose-600",
...
const SubCard = (props: {
  ...
  const { linkTo, imageUrl, Icon, name, color = "blue", description } = props;
  const styles = colorStyles[color];
  return (
    <Card
      className="group relative flex flex-col shadow-sm hover:cursor-pointer overflow-hidden p-10"
    ...
    >
      ...
      <button
        ...
        className={`absolute bottom-5 right-5 self-end flex items-center justify-center h-9 w-9 rounded-full text-slate-500 transition-colors ${styles.groupHoverBg} ${styles.hoverBg} hover:text-slate-900`}
      >
